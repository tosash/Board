...
public class FragmentAdsArhive extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private static String API_GET_ARHIVE_ADS = "/AdsArhive.php";
    ...
    private String TAG = FragmentAdsArhive.class.toString();
...
//        setRetainInstance(true);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_ads_arhive, container, false);
        return rootView;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            Gson gson = new Gson();
            String s = savedInstanceState.getString("adsArhive");
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString("adsArhive", s);
    }
